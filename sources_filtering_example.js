...
//   speedOverGround and courseOverGroundTrue are provided by two sources each.
// Note: with real data such charts may help in calibrating some instruments.
...
// This will decrease chances a "fast" source mask another "slower" one when filtering on sources
// (a 'large' minPeriod may result in long interrupted plot lines).
options.subscribePolicy.policy = "instant";
options.subscribePolicy.minPeriod = 20;
