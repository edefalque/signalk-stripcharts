...
// deltas with timeStamp out of tolerance (e.g. 20 sec) are skipped and logged to console
var timeToleranceSec = 20;    // 20 sec
...
var logMax = 500;   // logging ignored after logMax invocations
var logTypes = "";  // "sbweo";  // specifies types of info to be logged; no logging if ""
// s for specs,
